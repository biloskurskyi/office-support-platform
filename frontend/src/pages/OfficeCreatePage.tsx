...
const OfficeCreatePage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!formData.country || !formData.city || !formData.address || !formData.phone_number) {
            setErrorMessage('Будь ласка, заповніть усі поля');
            return;
        }

        try {
            const response = await axios.post(`http://localhost:8765/api/office/`,
                formData, {
                    headers: {
        ...
        <div>
            ...
            >
                <FormPaper title="Реєстрація">
                    <form onSubmit={handleSubmit}>
                        <Grid container spacing={2}>
                            ...
                            <ul>
                                ...
                                <li>При створенні офісу він автоматично прив'язується до компанії, в якій його
                                    створили.
                                </li>
                                <li>Обов'язково потрібно заповнити місце розташування офісу.</li>
                                <li>Якщо в компанії є зареєстровані менеджери, то можна вибрати менеджера, який буде
                                    мати доступ до управління цим офісом.
                                </li>
                            </ul>
                    ...
                    <hr/>
                    <Link to={`/office-list/${id}`} style={{textDecoration: 'none', color: 'inherit'}}>
                        <Box sx={{
                            display: 'flex',
                            justifyContent: 'center',
                            marginTop: '30px',
