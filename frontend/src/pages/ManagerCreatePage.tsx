  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(
        'http://localhost:8765/api/register-manager/',
        formData,
        {
          headers: {
          ...
          <form onSubmit={handleSubmit}>
            <Grid container spacing={2}>
              ...
              <ul>
                ...
                <li>
                  При створенні менеджера він автоматично прив'язується до
                  компанії, в якій його створили.
                </li>
                <li>
                  За замовчуванням менеджер є неактивним користувачем, поки він
                  не підтвердить отримання листа та не увійде в систему.
                </li>
