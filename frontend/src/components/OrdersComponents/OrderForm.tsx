    ...
    <>
      <form onSubmit={handleSubmit}>
          ...
          <Grid item xs={12}>
            ...
            >
              ...
              >
                ...
                {providers.map(
                  (manager: { id: number; name: string; address: string }) => (
                    <MenuItem
                      key={manager.id}
                      value={manager.id}
                      sx={{
        ...
        <ul>
          ...
          <li>
            Замовлення для офісу повинно містити: унікальну назву, вартість
            угоди, валюту угоди, звіт з підтвердженням угоди, назву
            постачальника який належить компанії.
          </li>
          <li>
            Якщо компанія не має власного постачальника, вона повина створити
            його та після того добавляти замовлення.
          </li>
        </ul>
