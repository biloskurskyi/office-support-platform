  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(
        'http://localhost:8765/api/register/',
        formData
      );
      ...
      if (error.response) {
        ...
        if (error.response.status === 400) {
          if (error.response.data.message === 'Email is already taken') {
            ...
            setErrorMessage(
              'Невірно введена електронна адреса або користувач' +
        ...
        <form onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            ...
            <ul>
              ...
              <li>
                Ввести пароль від 8 символів, щонайменше 1 великої літери та
                цифри.
              </li>
              <li>Підтвердити пароль.</li>
              <li>
                Очікуйте листа на вашу електронну адресу, щоб підтвердити
