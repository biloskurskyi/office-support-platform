    ...
    <>
      <form onSubmit={handleSubmit}>
        ...
        <ul>
          ...
          <li>
            В одній компанії постачальник має мати унікальний номер телефону або
            електронну адресу.
          </li>
          <li>Банківські реквізити не можуть повторюватися.</li>
          <li>
            Поле "Електронна адреса" або "Номер телефону" може бути пустим, але
            щонайменше одне з них обов'язково має бути заповнене.
          </li>
        </ul>
